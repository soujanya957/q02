...
module.exports = {
  ...
  body: (p) => `
      (module rotary_encoder (layer F.Cu) (tedit 603326DE)
          ...
          (fp_line (start -0.62 -0.04) (end 0.38 -0.04) (layer B.SilkS) (width 0.12))
          (fp_line (start -0.12 -0.54) (end -0.12 0.46) (layer B.SilkS) (width 0.12))
          (fp_line (start 5.98 3.26) (end 5.98 5.86) (layer B.SilkS) (width 0.12))
          (fp_line (start 5.98 -1.34) (end 5.98 1.26) (layer B.SilkS) (width 0.12))
          (fp_line (start 5.98 -5.94) (end 5.98 -3.34) (layer B.SilkS) (width 0.12))
          (fp_line (start -3.12 -0.04) (end 2.88 -0.04) (layer F.Fab) (width 0.12))
          (fp_line (start -0.12 -3.04) (end -0.12 2.96) (layer F.Fab) (width 0.12))
          (fp_line (start -7.32 -4.14) (end -7.62 -3.84) (layer B.SilkS) (width 0.12))
          (fp_line (start -7.92 -4.14) (end -7.32 -4.14) (layer B.SilkS) (width 0.12))
          (fp_line (start -7.62 -3.84) (end -7.92 -4.14) (layer B.SilkS) (width 0.12))
          (fp_line (start -6.22 -5.84) (end -6.22 5.86) (layer B.SilkS) (width 0.12))
          (fp_line (start -2.12 -5.84) (end -6.22 -5.84) (layer B.SilkS) (width 0.12))
          (fp_line (start -2.12 5.86) (end -6.22 5.86) (layer B.SilkS) (width 0.12))
          (fp_line (start 5.98 5.86) (end 1.88 5.86) (layer B.SilkS) (width 0.12))
          (fp_line (start 1.88 -5.94) (end 5.98 -5.94) (layer B.SilkS) (width 0.12))
          ...
          ${"" /* Legs */}
          (pad "" np_thru_hole rect (at -0.12 -5.64 ${
            p.rot
          }) (size 3.2 2) (drill oval 2.8 1.5) (layers *.Mask))
          (pad "" np_thru_hole rect (at -0.12 5.56 ${
            p.rot
          })  (size 3.2 2) (drill oval 2.8 1.5) (layers *.Mask))
      )
  `,
